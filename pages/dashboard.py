...
class Dashboard:
    ...
    def navigate_to_data_issues(self):
        ...
        # TODO: Replace the fixed timeout with a more robust wait condition that ensures the Data Issues grid is fully loaded before proceeding with assertions in the tests.
        self.page.wait_for_timeout(1000)  # Wait for the Data Issues grid to load